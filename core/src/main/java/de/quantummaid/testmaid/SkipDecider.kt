...
data class ExecutionDecision(val execute: Boolean, val reason: String)
...
interface SkipDecider {
    ...
    fun skipTestClass(testClassData: TestClassData, testSuiteScopedInjector: Injector): ExecutionDecision
...
private class AlwaysExecute : SkipDecider {
    ...
    override fun skipTestCase(testCaseData: TestCaseData, testSuiteScopedInjector: Injector): ExecutionDecision {
        return ExecutionDecision(true, "Test cases are executed by default")
    }
}
