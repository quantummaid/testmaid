...
internal fun testSuiteStateMachine(timeoutSettings: TimeoutSettings): StateMachineActor<TestSuiteState, TestSuiteMessage> {
    return testSuiteStateMachineBuilder(timeoutSettings).build()
}

private fun testSuiteStateMachineBuilder(
    timeoutSettings: TimeoutSettings
): StateMachineBuilder<TestSuiteState, TestSuiteMessage> {
    return aStateMachineUsing<TestSuiteState, TestSuiteMessage>("TestSuiteActor")
        ...
        .withTransition<ReadyToExecute, RegisterTestClass, ReadyToExecute> {
            val testClassActor = TestClassActor.aTestClassActor(timeoutSettings)
