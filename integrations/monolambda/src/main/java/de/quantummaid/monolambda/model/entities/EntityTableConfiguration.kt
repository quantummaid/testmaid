...
data class EntityTableConfiguration<Entity : Any>(
        val type: KClass<Entity>,
        val tableName: DynamoDbTableName,
        val idPropertyName: DynamoDbPropertyName = DynamoDbPropertyName("id"),
        val mvccIdPropertyName: DynamoDbPropertyName = DynamoDbPropertyName("mvccId"),
) {
