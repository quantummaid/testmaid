...
fun InjectMaidBuilder.withDynamoDbConfiguration(): InjectMaidBuilder {
    this.withConfiguration(DynamoDbInjectorConfiguration())
    return this
}

private class DynamoDbInjectorConfiguration : InjectorConfiguration {
