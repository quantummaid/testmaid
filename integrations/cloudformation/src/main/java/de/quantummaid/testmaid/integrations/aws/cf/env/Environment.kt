...
interface CloudFormationEnvironmentStack {
    val name: StackPrefix

    fun buildStackDefinition(stackName: StackName) : StackDefinition

    fun preCreateOrUpdate(stackName: StackName) : Parameters
