...
import de.quantummaid.testmaid.integrations.aws.cf.plain.api.Parameters
...
data class EnvironmentStackDefinition(
        val body: Body,
    ...
    fun md5Sum(): Md5Sum {
        ...
        return md5SumOf(
            body.md5Sum(), parameters.md5Sum(), tags.md5Sum(), capabilitiesMd5Sum
        )
    }

    override fun toString(): String {
        return "StackDefinition(body='...', parameters=$parameters, tags=$tags, capabilities=$capabilities)"
    }
}
