...
class UpdateStackFailed(val stackDefinition: StackDefinition, val stack: Stack, failedResources: List<String>) : Exception(
        "Failed to update stack. Status: ${stack.stackStatusAsString()}(${stack.stackStatusReason()}), " +
