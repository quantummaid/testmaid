...
import de.quantummaid.monolambda.awssdk.common.withAwsConfiguration
import de.quantummaid.monolambda.awssdk.dynamodb.withDynamoDbConfiguration
    ...
    companion object {
        ...
        fun testMaid(): TestMaid {
            val injectMaidBuilder = InjectMaid.anInjectMaid()
                    ...
                    .closeOnJvmShutdown()
                    .withAwsConfiguration()
                    .withDynamoDbConfiguration()
